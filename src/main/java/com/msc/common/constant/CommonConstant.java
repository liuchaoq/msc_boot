...
public interface CommonConstant {
    ...
    /**访问权限认证未通过 510*/
    public static final Integer SC_BSDCLOUD_NO_AUTHZ=510;

    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:org.bsdcloud.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
    ...
    */
    ...
    /** sys_group 表 code 唯一键索引 */
    public static final String SQL_INDEX_UNIQ_SYS_GROUP_CODE = "uniq_sys_group_group_code";
     ...
     * 判断只有一个用户usertoken
     */
    public final static String PREFIX_ONLY_USER_TOKEN = "prefix_only_user_token";

    public final static String DINGDING_TOKEN = "dingding_token";
}
