package com.msc.common.redis.writer;
 ...
 */
@Slf4j
public class BsdRedisCacheWriter implements RedisCacheWriter {

    private final RedisConnectionFactory connectionFactory;
    private final Duration sleepTime;

    public BsdRedisCacheWriter(RedisConnectionFactory connectionFactory) {
        this(connectionFactory, Duration.ZERO);
    }

    public BsdRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
