package com.msc.common.util.oss;
...
import com.msc.common.util.CommonUtils;
import com.msc.common.util.StrAttackFilter;
import com.msc.common.util.oConvertUtils;
...
//            ossClient.setBucketAcl(newBucket, CannedAccessControlList.PublicRead);
            ...
            e.printStackTrace();
            log.error("上传阿里云服务文件失败:"+ e.getMessage());
            return null;
        }
        return FILE_URL;
    }
    ...
    */
     ...
     * @return
             */
    public static String upload(AliCloudOSSProperties properties,MultipartFile file, String fileDir) {
        setEndPoint(properties.getEndpoint());
        setBucketName(properties.getBucketName());
